...
#region SIGNAL CALLBACKS
	...
	{
		//TODO : disconnect StateManager signals of specific level (eg : "Level0_DayNightCycle_StartNewCycle")
		Disconnect_StateManagerSignals();
...
#region USER METHODS
	...
	private void Disconnect_StateManagerSignals()
	{
		if (Nucleus_Utils.State_Manager.IsConnected("Level0_DayNightCycle_StartNewCycle", this, "onUIPlayer_StartNewCycle"))
			Nucleus_Utils.State_Manager.Disconnect("Level0_DayNightCycle_StartNewCycle", this, "onUIPlayer_StartNewCycle");
	}
